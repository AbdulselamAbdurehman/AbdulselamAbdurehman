...
If you suspect a library is broken, create a tiny script that *only* uses that library. If it works there, the issue is in your integration. Isolate the variables until only the bug remains.
